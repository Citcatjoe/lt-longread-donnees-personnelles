jQuery(document).ready(function($)
{
  ...
  function init() {
    ...
    parameters = [
      ...
      [[ 0.5, 0.2, 0.25 ], sprite2, 40 ],
      [[ 0.5, 0.1, 0.25 ], sprite3, 40 ],
      [[ 0.5, 0.05, 0.25 ], sprite1, 40 ],
      [[ 0.5, 0, 0.25 ], sprite5, 40 ],
      [[ 0.5, 0, 0.25 ], sprite4, 30 ]
    ...
    $('#canvasloader-container canvas').fadeIn();
    $('#canvasloader-container canvas').css('opacity', 1)
  }
  ...
  function render() {
    ...
    for ( var i = 0; i < scene.children.length; i ++ ) {
      ...
      if ( object instanceof THREE.Points ) {
        ...
        // On peut changer la vitesse de déplacement ici
        object.rotation.y = time * 0.5 * ( i < 4 ? i + 1 : - ( i + 1 ) );
